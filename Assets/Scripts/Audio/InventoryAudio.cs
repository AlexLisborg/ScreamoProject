...
public class InventoryAudio : Audio
{
    ...
    public AudioClip tryUnlock;
    public AudioClip equipPistol;
    public AudioClip equipBaton;
    ...
    public void PlayAudio(InventoryEvent invEvent)
    {
        switch (invEvent)
        {
            ...
            case InventoryEvent.destroyItem:
                ...
                break;
            case InventoryEvent.unlockDoor:
                PlayAudio(unlockDoor);
                break;
            case InventoryEvent.tryUnlock:
                PlayAudio(tryUnlock);
                break;
            case InventoryEvent.equipBaton:
                PlayAudio(equipBaton);
                break;
            case InventoryEvent.equipPistol:
                PlayAudio(equipPistol);
                break;
            default: break;
        }
    }
